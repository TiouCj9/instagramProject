...
import org.scalatest.matchers.should.Matchers
  ...
  case class PostInfoData (comments_disabled: Boolean, dimensions: Dimensions, display_url: String, edge_media_preview_like: Edge_media_preview_like, edge_media_to_caption: Edge_media_to_caption,
                            edge_media_to_comment:Edge_media_to_comment, gating_info: String, id: String, is_video: Boolean, location: String, media_preview: String, owner:Owner,
                            shortcode: String, tags: Tags, taken_at_timestamp: Long, thumbnail_resources:Thumbnail_Resources, thumbnail_src: String, urls:Urls, username: String)
  ...
  case class Edge_media_to_caption (edge_media_to_caption: Array[Edge_media_to_captionData] )
  case class Edge_media_preview_like(count: Long)
  case class Edge_media_to_captionData(node:Node)
  case class PostInfoS (comments_disabled: Boolean, dimensions_height: Long, dimensions_width: Long, display_url: String, edge_media_preview_like_count: Long, edge_media_to_caption_edges_node_text:String,
                        edge_media_to_comment_count: Long, gating_info: String, id: String, is_video: Boolean, location: String, media_preview: String,  owner_id: String, shortcode: String, tags: Tagss,
                        taken_at_timestamp: Long, thumbnail_resources: Thumbnail_Resourcess,thumbnail_src: String, urls: Urlss, username: String)
  case class Tagss (tags: Array[String])
  case class Urlss ( urls: Array[String])
  case class Thumbnail_Resourcess(Thumbnail_Resources: Array[Thumbnail_ResourcesDataa])
  case class Thumbnail_ResourcesDataa (config_height: Long, config_width: Long, src: String)
