...
import com.fluidcode.processing.silver.ProfileInfoUtils._
...
class ProfileInfoTableSpec extends AnyFlatSpec with Matchers with GivenWhenThen {
  "getProfileInfoTable" should "extract comments data from raw data" in {
    ...
    Given("the raw data")
    val input = Seq(GraphProfileInfoData(ProfileData(1286323200,info = Data("",23156762,1092,"Philippe Coutinho","1382894360",false,false,false,618,
    ...
    val ProfileTable = profileInfoData(input)
